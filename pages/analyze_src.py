...
st.title("Opialda's Feelings Analyzer 💥 ")
st.markdown("""
Welcome to mervins Streamlit app for analyzing different feelings 🛠️.
...
model_filename = './pages/opialdaAnalyzerTest_model.sav'
...
def classify_feeling():
    if message:
        ...
        if message_tone == 'happy':
            ...
            st.write("Your Feelings is Valid and Relevant✨")
    else:
