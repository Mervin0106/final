...
def load_model():
    try:
        with open('pages/wildcats_.p', 'rb') as f:
            model = pickle.load(f)
        return model
...
st.write("## 🐱ྀི WILL BREED CATS Classification Model 🐱ྀི")
st.write(":smiley: Upload an image of a 🐈cats, and we'll predict its category based on our trained model! :smiley:")
st.write(" 🐆 🐅 🐈ฅ≽^•⩊•^≼ฅ  ᨐᵉᵒʷ 🐈🐅🐆")
...
if my_upload is not None:
    ...
    st.write("This app is developed by Mervin Opialda of BSIS 3B.")
